...
import {TOAST_CONF, TOAST_POSITION, TOAST_SIZE, TOAST_TYPE, VgToastConfig} from "./vg-toast.config";
...
export class VgToastModule {
  ...
  public static forRoot(config?: VgToastConfig): ModuleWithProviders<VgToastModule> {
